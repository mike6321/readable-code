...
//        int selectColumnIndex = boardIndexConverter.getSelectedColumnIndex(cellPosition);
//        int selectedRowIndex = boardIndexConverter. getSelectedRowIndex(cellPosition);
